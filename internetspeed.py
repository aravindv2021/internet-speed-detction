...
lab = Label(sp,text = 'DownloadSpeed',font = ("Time New Roman",30,"bold"))
...
buttom = Button(sp,text= 'CHECK SPEED',font = ("Time New Roman",30,"bold"),relief=RAISED,bg = 'Red',command=speedcheck)
buttom.place(x = 60,y= 460,height=50,width=380)
sp.mainloop()
